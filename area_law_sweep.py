...
PRESET    = os.path.join(os.path.dirname(__file__), 
                         "presets", "bose_hubbard_8_particle.toml")
TICKS     = 20000
GRID      = 64
# ─────────────────────────────────────────────────────────────────
...
def run_single(uj_ratio: float) -> dict:
    ...
    # Half-chain partition: [0,1,2,3] | [4,5,6,7]
    half_a = [0, 1, 2, 3]
...
def main():
    ...
    csv_path = os.path.join(out_dir, "area_law_sweep_results.csv")
    ...
    ax1.set_title("8-Particle Area Law Scaling", 
    ...
    plot_path = os.path.join(out_dir, "area_law_sweep_S2_vs_UJ.png")
